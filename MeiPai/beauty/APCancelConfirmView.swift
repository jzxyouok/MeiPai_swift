...
class APCancelConfirmView: UIView {
    ...
    private func addCancelButton() {
        ...
        cancelButton.addTarget(self, action: #selector(APCancelConfirmView.cancelButtonPressed(_:)), forControlEvents: UIControlEvents.TouchUpInside)
    ...
    private func addConfirmButton() {
        ...
        confirmButton.addTarget(self, action: #selector(APCancelConfirmView.confirmButtonPressed(_:)), forControlEvents: UIControlEvents.TouchUpInside)
