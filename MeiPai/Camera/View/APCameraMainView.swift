...
class APCameraMainView: UIView {
    ...
    func addPreviewImageView() {
        if self.previewImageView == nil {
            ...
            let tap = UITapGestureRecognizer.init(target: self, action: Selector("toPhotoBrowse"))
...
//            let button = UIButton.init(frame: CGRectMake(kScreenWidth*floatIndex/5, 0, kScreenWidth/5, kNavigationHeight))
            ...
            button.addTarget(self, action: #selector(APCameraMainView.topButtonPressed(_:)), forControlEvents: UIControlEvents.TouchUpInside)
    ...
    func addAlbumButton() {
        ...
        self.albumButton.addTarget(self, action: #selector(APCameraMainView.browsePhoto), forControlEvents: UIControlEvents.TouchUpInside)
    ...
    func addTriggerButton() {
        ...
        triggerButton.addTarget(self, action: #selector(APCameraMainView.triggerButtonPressed(_:)), forControlEvents: UIControlEvents.TouchUpInside)
    ...
    func addCloseButton() {
        ...
        closeButton.addTarget(self, action: #selector(APCameraMainView.closeButtonPressed(_:)), forControlEvents: UIControlEvents.TouchUpInside)
